...
<body style="background-image: url('images/background2.jpg'); !important">
  ...
  <div class="container ">
    <h1 class="text-center font-80px margin-bottom50"> <b>Welcome <?php echo $_SESSION['name']; ?>"Juicy, Sweet, and Always Fresh – Dive into Mango Bliss Market!"
</b></h1>
        ...
        <div class="row">
          ...
          <div class="col-md-12 bio-tab">
            <div class="row">
              ...
              <div class="col-md-8">
                <h1 class="text-center"> <b>About Mango_Bliss_Market.com</b> </h1>
               
                <p>&nbsp&nbsp&nbsp&nbsp<b><i>India’s Ultimate Online Mango Shopping Site <b>Mango_Bliss_Market.com</b>’s vision is to create India’s most reliable and frictionless commerce ecosystem that creates life-changing experiences for buyers and sellers.<b>Mango_Bliss_Market.com</b> is India’s largest online Mango shopping marketplace. A Boon The trend of online shopping is becoming a household name and so is Mango_Bliss_Market.</i></b></p>  
              </div>
            </div>
          </div>
